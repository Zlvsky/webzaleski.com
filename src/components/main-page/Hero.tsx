      ...
      <div className="relative pb-16 ">
        <div className="grid grid-cols-1 items-center gap-12 pt-10 lg:grid-cols-2">
          <div className="flex flex-col">
            <div className="mx-auto mb-2 flex w-max items-center gap-1 rounded-full border border-[#f0f0f0] bg-white py-2 pl-3 pr-4 text-xs leading-3 shadow-glossyinside sm:mx-0">
              <PingDot />
              {t('availableFor')}
